...
class Alerts extends Component {
    state = {
        ...
        alertsOne: [{
            ...
            type: 'danger',
            icon: dangerIcon,
            msg: '<span class="fw-semi-bold">Danger:</span> Contraseña y usuario incorrectos, intente nuevamente',
            visible: true,
        }],
        alertsTwo: [{
            id: 'al-5',
            ...
            id: 'al-8',
            type: 'danger',
            msg: '<span class="fw-semi-bold">Danger:</span> Contraseña y usuario incorrectos, intente nuevamente</a>',
            visible: true,
        }]
    };
